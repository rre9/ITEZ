...
{
    /// <inheritdoc />
    public partial class AddTicketsModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketLogs_AspNetUsers_PerformedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketLogs_PerformedById",
                table: "TicketLogs",
